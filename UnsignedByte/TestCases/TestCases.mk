...
RcCmpOptions=
LinkOptions=
IncludePath=$(IncludeSwitch). $(IncludeSwitch)../include $(IncludeSwitch)../Core $(IncludeSwitch)$(HOME)/local/include 
RcIncludePath=
Libs=$(LibrarySwitch)ubdal $(LibrarySwitch)ubresource $(LibrarySwitch)sqlite3 
LibPath=$(LibraryPathSwitch)../lib $(LibraryPathSwitch)$(HOME)/local/lib 
endif
...
$(IntermediateDirectory)/chunkimporter$(ObjectSuffix): ../Core/chunkimporter.cpp $(IntermediateDirectory)/chunkimporter$(ObjectSuffix).d
	$(CompilerName) $(SourceSwitch)../Core/chunkimporter.cpp $(CmpOptions)   $(ObjectSwitch)$(IntermediateDirectory)/chunkimporter$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Chunk$(ObjectSuffix): ../Core/Chunk.cpp $(IntermediateDirectory)/Chunk$(ObjectSuffix).d
	$(CompilerName) $(SourceSwitch)../Core/Chunk.cpp $(CmpOptions)   $(ObjectSwitch)$(IntermediateDirectory)/Chunk$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/ChunkManager$(ObjectSuffix): ../Core/ChunkManager.cpp $(IntermediateDirectory)/ChunkManager$(ObjectSuffix).d
	$(CompilerName) $(SourceSwitch)../Core/ChunkManager.cpp $(CmpOptions)   $(ObjectSwitch)$(IntermediateDirectory)/ChunkManager$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Detail$(ObjectSuffix): ../Core/Detail.cpp $(IntermediateDirectory)/Detail$(ObjectSuffix).d
	$(CompilerName) $(SourceSwitch)../Core/Detail.cpp $(CmpOptions)   $(ObjectSwitch)$(IntermediateDirectory)/Detail$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DetailManager$(ObjectSuffix): ../Core/DetailManager.cpp $(IntermediateDirectory)/DetailManager$(ObjectSuffix).d
	$(CompilerName) $(SourceSwitch)../Core/DetailManager.cpp $(CmpOptions)   $(ObjectSwitch)$(IntermediateDirectory)/DetailManager$(ObjectSuffix) $(IncludePath)
